...
public class FileUtils {
    ...
    public static File createFile(Context context){
        ...
        if(Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
            ...
            file = new File(Environment.getExternalStorageDirectory()+ File.separator+"MoveSurvey"+ File.separator + timeStamp+".jpg");
    ...
    public static File createFileNew(Context context, String dir, String fileName){
        File file;
        String sdpath = Environment.getExternalStorageDirectory().getAbsolutePath();// 获取sdcard的根路径
        String filePath = sdpath + File.separator + "MoveSurvey" + File.separator;
        ...
        if(Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
            ...
            file = new File(filePath + dir + File.separator + fileName);
    ...
    public static boolean isImage(String fileName, Context context){
